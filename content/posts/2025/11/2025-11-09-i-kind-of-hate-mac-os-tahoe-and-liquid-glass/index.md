...
I've been running Linux for a while now as daily driver, but since I was thinking that [I may have to use macOS on the desktop](https://baty.net/posts/2025/11/i-may-have-to-use-macos-on-the-desktop/), I've spent a lot of time using both Linux and macOS. Now I kind of hate Tahoe and Liquid Glass.
...
Using macOS was always about the software, hardware, and OS. Apple still makes great hardware, and app developers still make great software, but macOS no longer feels all that much better than alternatives. If I decide to stay with a Mac on the desktop, it'll be for the apps, _in spite_ of macOS.
